...
__all__ = ['Wide_ResNet_2D_Resize_Norm']
...
class Wide_ResNet_2D_Resize_Norm(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes):
        super(Wide_ResNet_2D_Resize_Norm, self).__init__()
        self.in_planes = 16
...
if __name__ == '__main__':
    net=Wide_ResNet_2D_Resize_Norm(28, 10, 0.3, 10)
