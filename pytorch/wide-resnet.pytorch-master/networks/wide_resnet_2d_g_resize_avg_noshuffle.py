...
__all__ = ['Wide_ResNet_2D_G_Resize_Avg_NoShuffle']
...
class Wide_ResNet_2D_G_Resize_Avg_NoShuffle(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, groups):
        super(Wide_ResNet_2D_G_Resize_Avg_NoShuffle, self).__init__()
        self.in_planes = 16
...
if __name__ == '__main__':
    net=Wide_ResNet_2D_G_Resize_Avg_NoShuffle(28, 10, 0.3, 10)
