...
class ConvCust(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1, kernel_size=3, padding=0, bias=True):
        ...
        self.weight = nn.Parameter(torch.Tensor(out_planes, in_planes, *self.kernel_size))
...
class Wide_ResNet_2D_Normal(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes):
        super(Wide_ResNet_2D_Normal, self).__init__()
        self.in_planes = 16
...
if __name__ == '__main__':
    net=Wide_ResNet_2D_Normal(28, 10, 0.3, 10)
