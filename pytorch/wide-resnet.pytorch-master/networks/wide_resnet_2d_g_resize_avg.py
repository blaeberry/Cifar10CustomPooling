...
__all__ = ['Wide_ResNet_2D_G_Resize_Avg']
...
class Wide_ResNet_2D_G_Resize_Avg(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes, groups):
        super(Wide_ResNet_2D_G_Resize_Avg, self).__init__()
        self.in_planes = 16
...
if __name__ == '__main__':
    net=Wide_ResNet_2D_G_Resize_Avg(28, 10, 0.3, 10)
