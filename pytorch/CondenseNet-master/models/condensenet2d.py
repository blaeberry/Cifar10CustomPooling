...
import math
from layers2d import Conv, LearnedGroupConv

__all__ = ['CondenseNet2d']
...
class _DenseLayer(nn.Module):
    def __init__(self, in_channels, growth_rate, args):
        ...
        self.conv_1 = LearnedGroupConv(in_channels, args.bottleneck * growth_rate,
                                       kernel_size=3, groups=self.group_3x3,
                                       condense_factor=args.condense_factor,
                                       dropout_rate=args.dropout_rate, padding=1)
        ### 3x3 conv b*k --> k
...
class CondenseNet2d(nn.Module):
    def __init__(self, args):

        super(CondenseNet2d, self).__init__()
