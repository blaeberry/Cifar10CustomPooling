...
def custom_pooling2d(inputs, var_scope, padding, data_format='channels_first'):
    with tf.variable_scope(var_scope):
        max_inputs = tf.layers.max_pooling2d(inputs, pool_size=2, strides = 2, padding = padding, data_format=data_format, name='pool_max')
        avg_inputs = tf.layers.average_pooling2d(inputs, pool_size=2, strides = 2, padding = padding, data_format=data_format, name='pool_avg')
