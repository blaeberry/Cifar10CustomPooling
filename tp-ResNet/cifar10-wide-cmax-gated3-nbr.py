...
def custom_pooling2d(inputs, var_scope, padding, nf = 4, size = 3, strides = [1, 1, 2, 2], data_format='NCHW'):
    with tf.variable_scope(var_scope):
        l = inputs
        max_inputs = tf.layers.max_pooling2d(inputs, pool_size=3, strides = 2, padding = 'SAME', data_format = 'channels_first', name='pool_max')
